...
namespace Kitchen
{
    public partial class FormMain : Form
    {
        ...
        {
            var kitchen1 = new KitchenType("Українська");
            var kitchen2 = new KitchenType("Азійська");
            var kitchen3 = new KitchenType("Європейська");
            var kitchen4 = new KitchenType("Американська");

            var course1 = new CourseType("Перша страва");
            var course2 = new CourseType("Основна страва");
            var course3 = new CourseType("Салат");
            var course4 = new CourseType("Десерт");
            var course5 = new CourseType("Напій");

            var myDish1 = new Dish("Борщ", kitchen1, course1);
            ...
            var myDish2 = new Dish("Рамен", kitchen2, course2);
            ...
            var myDish3 = new Dish("Вареники з картоплею", kitchen1, course2);
            ...
            var myDish4 = new Dish("Цезар", kitchen3, course3);
            ...
            var myDish5 = new Dish("Кола", kitchen4, course5);
            ...
            var myDish6 = new Dish("Мотті", kitchen2, course4);
        ...
        {
            //lbIngredients.DataSource = Dish.Ingredients.Values.ToList();
        }
    }
}
