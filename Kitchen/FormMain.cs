...
namespace Kitchen
{
    public partial class FormMain : Form
    {
        ...
        {
            var myDish1 = new Dish("Борщ", "Перша страва", "Українська");
            ...
            var myDish2 = new Dish("Рамен", "Основна страва", "Азійська");
            ...
            var myDish3 = new Dish("Вареники з картоплею", "Основна страва", "Українська");
            ...
            var myDish4 = new Dish("Цезар", "Салат", "Європейська");
            ...
            var myDish5 = new Dish("Кола", "Напій", "Американська");
            ...
            var myDish6 = new Dish("Мотті", "Десерт", "Азійська");
            ...
            lbDish.DataSource = Dish.Ingredients.Values.ToList();
        }
